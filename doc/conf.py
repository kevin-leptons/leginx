...
# -*- coding: utf-8 -*-
#
# leginx documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'leginx.tex', 'leginx Documentation',
...
man_pages = [
    (master_doc, 'leginx', 'leginx Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'leginx', 'leginx Documentation',
     author, 'leginx', 'One line description of project.',
     'Miscellaneous'),
]
